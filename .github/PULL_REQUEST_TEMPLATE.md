...
- [ ] This adds no game assets, disc images, `default.xex`, decrypted
      intermediates, platform keys, or generated translation units.
- [ ] `tools/check_no_game_content.sh` passes.
